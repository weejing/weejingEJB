<%-- 
    Document   : Payment
    Created on : Mar 19, 2016, 1:47:50 AM
    Author     : WeeJing
--%>
                    ...
                    <div class="credit-card-div">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <form action = "listOrders?orderId=<%= orderId%>" onsubmit="checkPrice();" method="POST" >  
                                    
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type ="number" name="cardNum" class="form-control" placeholder="Enter card number"/> 
                                        </div>     
                                    </div>
                                    <div class ="row">
                                        ...
                                        <div class="col-md-5 col-xs-4">
                                            ...
                                            <input type ="number" name="amount" id="amountPaid" class="form-control"/>
                                        </div>  
                                    </div>
                                    <div class ="row">
                                        <div class="col-md-12 pad-adjust">
                                            <input type ="text" name ="cardName" class="form-control" placeholder="Name of cardholder"/>
                                        </div>
                                    </div>
                                    <div class="row">
